...
export default new Router({
    ...
    },
    {
        ...
        },
        {
            ...
            redirect: '/test1/test1-2',     // 该配置是若点击选择一级菜单时，默认选中并跳转到该一级菜单下的第一个二级菜单
            children: [
                {
                    path: 'test1-1',
        ...
        },
        {
            ...
            // redirect: '/test3/test3-2-2-4-1',
            children: [
                {
                    path: '/test3-2-2-4-1',
                    component: () => import('../page/test3/test3-2/test3-2-1/test3-2-1-1.vue'),
                    meta: {
                        title: '客户'
                    }
                },
                {
                    path: '/test3-2-2-4-2',
                    component: () => import('../page/test3/test3-2/test3-2-1/test3-2-1-2.vue'),
                    meta: {
                        title: '客户状况'
                    }
                },
